        ...
        <main className="w-full h-auto min-h-screen ">
            <section id="hero" className="md:max-w-8xl mx-auto">
                        ...
                        <motion.div className="flex text-center md:text-left flex-col items-center justify-center md:flex md:items-start md:justify-normal font-epilogue text-[#5F5F5F]" variants={itemVariants}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <p className="font-spaceGrotesk text-[16px] text-[#012D9A] md:text-[20px] font-medium leading-none flex items-center justify-center tracking-normal mr-2">
                                        +
                                    </p>
                                ...
                                >
                                    <CountUp
                                        ...
                                        className="font-spaceGrotesk text-[16px] text-[#012D9A] md:text-[24px] font-medium leading-none flex items-center justify-center tracking-normal"
                                    />
                                    <p className="font-spaceGrotesk text-[16px] text-[#012D9A] md:text-[20px] font-medium leading-none flex items-center justify-center tracking-normal mr-1">
                                        +
                                    </p>
                                    <span className="font-epilogue relative top-[1px] md:top-[2px] text-[#012D9A] font-normal flex items-center justify-center md:text-[20px] text-[12px] leading-none md:w-[200px]">
                                        <ReactTyped
                                            strings={["Project Completed"]}
                                            typeSpeed={80}
                                            backSpeed={80}
                                            loop={true}
                                        />
                    ...
                    >
                        <motion.div
                            ...
                            <motion.div
                                ...
                                className="relative bg-[#012D9A] w-full h-[134px] rounded-br-[52px] rounded-bl-[52px]"
                            >
                                <div className="relative w-full mx-auto">
                                    <Link href="/projects" className="bg-[#FE0000] hover:bg-white hover:text-[#FE0000] hover:outline-[#FE0000] hover:outline-4 rounded-[120px] w-[115px] -bottom-[115px] px-4 py-2 flex items-center justify-center relative mx-auto h-[37px] outline outline-[7px] outline-[#EEEEEE] text-white transition-all duration-300 transform ease-in-out">
                                        <span className="font-spaceGrotesk font-bold text-[14px] flex items-center text-center">
                                            SEE MORE
                ...
                <div className="flex mx-auto flex-col md:mx-[159px] overflow-hidden mt-[36px]">
                    ...
                    {/* Line and Hook */}
                    <div id="line-wrapper" className="w-full  flex flex-col relative mx-auto overflow-visible">
                        <div id="line" className="flex bg-[#D6DBEA] border-2 border-[#D6DBEA]" />

                        {/* Hook Movement: Follows item for desktop, stays centered for mobile */}
                        <motion.div
                            id="hooks"
                        ...
                        <div
                            id="images"
                            ref={itemsRef}
                            className="flex md:items-center md:justify-center md:py-0 py-4 gap-[24px] flex-row md:gap-[40px] z-50 md:mb-[88px] overflow-x-auto md:overflow-visible snap-x snap-mandatory scrollbar-hide"
                        >
                            {[Dummy1, Dummy1, Dummy1, Dummy1].map((src, index) => (
                                <div
                                    key={index}
                                    className="relative cursor-pointer flex-shrink-0 md:w-[247px] z-50 snap-center" // w-[80vw] ensures each item takes 80% of viewport width on mobile
                ...
                <div id="CTA" className="w-full mb-[61px]">
                    <div className="relative flex items-center justify-center mx-[19px] md:mx-[149px]">
                        ...
                        >
                            <Image src={CTA} alt="cta-1" />
                        </motion.div>

                        {/* Mobile Image with Hover Zoom */}
                        <motion.div
                            whileHover={{ scale: 1.1 }}
                            transition={{ type: "spring", stiffness: 200, damping: 20 }}
                            className="md:hidden flex"
                        >
                            <Image src={CTAMobile} alt="cta-2" />
                        </motion.div>

                        {/* Text Content */}
                        <div className="absolute flex flex-col items-center justify-center w-[314px] text-center md:w-[618px]">
                            <h1 className="font-spaceGrotesk font-bold text-[32px] leading-[50px] text-white">
                                Expert Construction Service For Every Project
                            </h1>
                            <Link href="/contact-us" className="px-8 py-2 bg-[#FF0000] font-medium font-spaceGrotesk text-white mt-[15px] rounded-[70px]">
                                Contact Us
                            </Link>
                        </div>
                    </div>
                ...
                <div id="icons" className="flex flex-col w-full overflow-hidden">
                    ...
                    <div className="w-full flex overflow-hidden">
                        <div className="w-full mx-auto flex items-center justify-center md:hidden mb-[83px]">
                            <Image src={IconMobile} alt="icons" className="md:hidden mx-auto object-cover" />
                        </div>
                        <motion.div
                            ref={iconsRef}
                            className="hidden md:flex md:scroll-x space-x-4 mb-[83px] md:mx-[116px] w-[200%] md:mb-[83px]"
